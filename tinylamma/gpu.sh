...
pip install torch torchaudio transformers huggingface_hub networkx transformers[torch] 'accelerate>=0.26.0' peft 

pip install transformers huggingface_hub networkx transformers[torch] 'accelerate>=0.26.0' peft 
